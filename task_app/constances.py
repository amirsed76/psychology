...
APPRECIATION = "با سپاس از حُسن همکاری و مشارکت شما؛ می‌توانید امتیاز کسب شده در آزمون و میانگین زمان واکنش شما به تصاویر تکراری را ملاحظه کنید که نشان دهنده قدرت و سلامت حافظه رویدادی شما است."
