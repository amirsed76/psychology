...
•ما در این پژوهش تلاش کرده ایم، ابتدا ابزاری جهت اندازه گیری حافظه رویدادی طراحی، و سپس ویژگی های آن را ارزیابی و بررسی کنیم.
...
پس از پاسخگویی به پرسشنامه وارد مرحله اجرای آزمون و ابزار طراحی شده در این پژوهش می شوید. سادگی استفاده از آن از مهمترین ویژگی های این ابزار است؛ تعداد 50 تصویر به شما نمایش داده خواهد شد؛ اگر تصویری تکراری مشاهده کردید، بلافاصله دکمه فاصله (روی صفحه کلید رایانه ) را فشار دهید، و یا اگر از گوشی های هوشمند و لمسی استفاده می کنید، روی عکس ضربه بزنید.
...
HOW_DO_TASK = {
    ...
    "text": "انجام این آزمون بسیار ساده است. تعداد 50 تصویر به شما نمایش داده خواهد شد؛ اگر تصویری تکراری مشاهده کردید، بلافاصله دکمه فاصله (روی صفحه کلید رایانه ) را فشار دهید، و یا اگر از گوشی های هوشمند و لمسی استفاده می کنید، روی عکس ضربه بزنید."
}
...
APPRECIATION = "با سپاس از شما بخاطر حُسن همکاری و مشارکت در این پژوهش؛ شما می‌توانید امتیاز کسب شده در آزمون و میانگین زمان واکنش شما به تصاویر تکراری را ملاحظه کنید که نشان دهنده قدرت و سلامت حافظه رویدادی شما است."
